...
\section{Preamble}
In Latex the package that you use and document-wide settings are placed in the preamble.

\begin{enumerate}[label=\alph*)]
  \item Add the document class article.
  \item Add the package graphicx.
  \item Add meta data for a title, author and date (the command \verb|\today| gets the current date).
\end{enumerate}
